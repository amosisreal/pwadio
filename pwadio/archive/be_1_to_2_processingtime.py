...
cursor.execute("select id, station_ID_id, date_added, download_site_time, processing_time, total_elapsed_time, number_of_tracks_added_this_batch from " + table_name + " order by id limit 250")
