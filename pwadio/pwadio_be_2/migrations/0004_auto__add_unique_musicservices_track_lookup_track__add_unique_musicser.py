...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MusicServices_Track_Lookup', fields ['track']
        db.create_unique('pwadio_be_2_musicservices_track_lookup', ['track_id'])

        # Adding unique constraint on 'MusicServices_Artist_Lookup', fields ['artist']
        db.create_unique('pwadio_be_2_musicservices_artist_lookup', ['artist_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'MusicServices_Artist_Lookup', fields ['artist']
        db.delete_unique('pwadio_be_2_musicservices_artist_lookup', ['artist_id'])

        # Removing unique constraint on 'MusicServices_Track_Lookup', fields ['track']
        db.delete_unique('pwadio_be_2_musicservices_track_lookup', ['track_id'])
    ...
    models = {
        ...
        'pwadio_be_2.musicservices_artist_lookup': {
            ...
            'artist': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'unique': 'True', 'to': "orm['pwadio_be_2.Artist']"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'pwadio_be_2.musicservices_track_lookup': {
            ...
            'music_service': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['pwadio_be_2.MusicServices']"}),
            'music_service_object_id_from_web': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'track': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'unique': 'True', 'to': "orm['pwadio_be_2.Track']"})
        },
