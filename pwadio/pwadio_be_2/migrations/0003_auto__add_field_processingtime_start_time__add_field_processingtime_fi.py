...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcessingTime.start_time'
        db.add_column('pwadio_be_2_processingtime', 'start_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1700, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'ProcessingTime.finish_time'
        db.add_column('pwadio_be_2_processingtime', 'finish_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1700, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'ProcessingTime.finish_reason'
        db.add_column('pwadio_be_2_processingtime', 'finish_reason',
                      self.gf('django.db.models.fields.CharField')(default='this is made up.', max_length='200'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcessingTime.start_time'
        db.delete_column('pwadio_be_2_processingtime', 'start_time')

        # Deleting field 'ProcessingTime.finish_time'
        db.delete_column('pwadio_be_2_processingtime', 'finish_time')

        # Deleting field 'ProcessingTime.finish_reason'
        db.delete_column('pwadio_be_2_processingtime', 'finish_reason')
